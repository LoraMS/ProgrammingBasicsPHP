...
$b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\SoftUniBlogBundle\\Entity'), 1 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle\\Entity')));

$c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$c->addDriver($b, 'SoftUniBlogBundle\\Entity');
$c->addDriver($b, 'Vich\\UploaderBundle\\Entity');

$d = new \Doctrine\ORM\Configuration();
$d->setEntityNamespaces(array('SoftUniBlogBundle' => 'SoftUniBlogBundle\\Entity', 'VichUploaderBundle' => 'Vich\\UploaderBundle\\Entity'));
